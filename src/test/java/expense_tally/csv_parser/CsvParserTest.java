...
class CsvParserTest {
    ...
    private CsvTransaction assembleCsvTransaction(LocalDate transactionDate, String reference, Double debitAmount,
                                                  Double creditAmount, String transactionRef1, String transactionRef2,
                                                  String transactionRef3, TransactionType transactionType) {
    ...
    void parseCsvFile_parseOneRowDataNoTransactionRef() throws IOException {
        csvFileWriter.write("Transaction Date,TransactionType,Debit Amount,Credit Amount,Transaction Ref1,Transaction Ref2,Transaction Ref3\n");
        csvFileWriter.write("09 Nov 2018,ICT, 148.88,,Not PayNow,,\n");
        csvFileWriter.close();
    ...
    /**
     * Also there is empty line in the file so this need to be read and skipped.
     *
     * @throws IOException
     */
    @Test
     ...
     */
    @Test
    void parseCsvFile_masterCardEmptyTransactionRef2() throws IOException {
        csvFileWriter.write("Transaction Date,TransactionType,Debit Amount,Credit Amount,Transaction Ref1,Transaction Ref2,Transaction Ref3\n");
        csvFileWriter.write("\n");
        ...
        CsvTransaction expectedCsvTransaction = assembleCsvTransaction(
                ...
                TransactionType.MASTERCARD.value(),
                10.16,
                0.00,
                "test ref 1 SI NG 10OCT",
                "",
                "test ref 3",
